...
<div class="product-body">
           ...
           <div class="product-card position-relative">
             <div class="card-img position-relative">
               ...
               <?php if (strtolower($pr['availability']) == 'not available') : ?>
                 <span class="availability-badge position-absolute top-0 start-0 text-white px-2 py-1 small rounded-end">
                   Not Available
                 </span>
               <?php endif; ?>
              <?php if (!empty($pr['offer_percent']) && $pr['offer_percent'] > 0) : ?>
                 <span class="offer-badge position-absolute top-0 end-0 text-white bg-success px-2 py-1 small rounded-end">
  ...
  <svg class="quick-view bi bi-bag">
 ...
 <!--  <span class="text-decoration-line-through text-muted small">&#8377; <?php echo number_format($pr['original_price'], 2); ?></span> -->
<?php else: ?>
