...
<head>
  ...
  <script src="<?php echo base_url();?>assets/js/script.js"></script>
    ...
    <nav id="header-nav" class="navbar navbar-expand-lg fixed-top bg-light">
      <div class="container-lg">
        <a class="navbar-brand" href="<?php echo base_url('user/index'); ?>">
          <img src="<?php echo base_url('assets/images/logo-light.png'); ?>" alt="Logo" style="width: 60px; height: 60px;">
        </a>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar">
          ...
          <div class="offcanvas-body">
            <ul id="navbar" class="navbar-nav fw-bold justify-content-end align-items-center flex-grow-1">
              <li class="nav-item">
                <a class="nav-link me-5" href="<?php echo base_url('user/index'); ?>">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-5" href="<?php echo base_url('user/products'); ?>">Products</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-5" href="<?php echo base_url('user/about_us'); ?>">About Us</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-5" href="<?php echo base_url('user/contact_us'); ?>">Contact Us</a>
              </li>
            </ul>
          </div>
        </div>
  ...
  <?php if ($this->session->userdata('user_id')): ?>
    <a href="<?php echo base_url('user/profile'); ?>" class="border-0">
  <?php else: ?>
    <a href="<?php echo base_url('user/login'); ?>" class="border-0">
  <?php endif; ?>
